		...
		<>
			...
			<main className="py-4">
				<section className="container">
					<h3 className="py-2 text-primary border-bottom border-primary fw-bold">Phim mới cập nhật</h3>
				...
				<section className="container py-4">
					<h3 className="py-2 text-primary border-bottom border-primary fw-bold">Phim Việt Nam</h3>
					<div className="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 g-2">
						{vietnam.length > 0 ? (
