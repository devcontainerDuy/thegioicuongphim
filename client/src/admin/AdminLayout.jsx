    ...
    return (
        <div className="flex min-h-screen bg-zinc-950">
            ...
            <aside className={cn(
                ...
                <div className="p-4 border-t border-zinc-800">
                    ...
                    {sidebarOpen && (
                        <Button
                            variant="ghost"
                            className="w-full mt-3 justify-start text-red-400 hover:text-red-300 hover:bg-red-500/10"
                            onClick={logout}
                        >
            ...
            <main className={cn(
                ...
                {/* Header */}
                <header className="sticky top-0 z-40 h-16 flex items-center px-6 bg-zinc-900/80 backdrop-blur border-b border-zinc-800">
