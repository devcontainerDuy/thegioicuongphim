...
export class AuthService {
    ...
    async login(loginDto: LoginDto, remember: boolean = false, ipAddress?: string, userAgent?: string) {
    ...
    async loginWithRememberToken(rememberToken: string, ipAddress?: string, userAgent?: string) {
