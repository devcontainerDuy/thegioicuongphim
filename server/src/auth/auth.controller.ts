...
export class AuthController {
    ...
    async login(
        ...
        const result = await this.authService.login(loginDto, remember, ip, userAgent);
    ...
    async loginWithRemember(
        ...
        const result = await this.authService.loginWithRememberToken(rememberToken, ip, userAgent);
